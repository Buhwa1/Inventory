          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Active Trips <span>| This Month</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>50</h6>
                      <span class="text-success small pt-1 fw-bold">8</span> <span class="text-muted small pt-2 ps-1">Total Trips</span>
            ...
            <div class="col-12">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  <h5 class="card-title">Top Trasnsported Cargo <span>| Today</span></h5>
                  ...
                  <table class="table table-borderless">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a href="#" class="text-primary fw-bold">Laptops</a></td>
                        <td>$64</td>
                      ...
                      <tr>
                        ...
                        <td><a href="#" class="text-primary fw-bold">Sugar</a></td>
                        <td>$46</td>
